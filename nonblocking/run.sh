...
export LD_LIBRARY_PATH=/soft/perftools/hpctw/NONE:$LD_LIBRARY_PATH
I_MPI_ASYNC_PROGRESS_PIN=0 I_MPI_ASYNC_PROGRESS=1 $run -np 4 ./test_prefetch.x --num_batches 16 --batch_size 64 --compute_time 1 --nonblocking 1
